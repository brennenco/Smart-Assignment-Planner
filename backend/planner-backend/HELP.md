...
* The original package name 'com.smart_assignment_planner.planner-backend' is invalid and this project uses 'com.smart_assignment_planner.planner_backend' instead.
